...
public class P_PoliceActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.p_police);

		tvmotion = new TextView[3];
		tvmotion[0] =(TextView)findViewById(R.id.ptvmotion1);
		tvmotion[1] =(TextView)findViewById(R.id.ptvmotion2);
		tvmotion[2] =(TextView)findViewById(R.id.ptvmotion3);
		
		ivmotion =(ImageView)findViewById(R.id.pivmotion);
		
		motion1 = (Spinner) findViewById(R.id.pmotion1);
		motion2 = (Spinner) findViewById(R.id.pmotion2);
		motion3 = (Spinner) findViewById(R.id.pmotion3);
		
		ok=(Button)findViewById(R.id.PLsave);
		no=(Button)findViewById(R.id.PLcan);
		
		sw=(Switch)findViewById(R.id.pswitch);
		...
		Cursor cur = sqlDB.rawQuery("select * from pt where name='police';", null);
		...
		sw.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if(isChecked) { //On
					...
					value.put("state", 1);
					Constants.police[3]="1";
					
					sqlDB.update("pt", value, "name='police'", null);
			...
			public void onClick(View v) {
				...
				while (cur.moveToNext()) {
					if(cur.getString(1).equals(p[0])&&cur.getString(2).equals(p[1])&&cur.getString(3).equals(p[2])) {
						if(cur.getString(0).equals("police")) 
							duplication = 2;
						else 
							duplication = 1; //중복
					}
				...
				if(duplication==0) { //중복되지 않을 경우 DB에 저장
					...
					ContentValues value = new ContentValues();
					value.put("name", "police");
					value.put("p1", p[0]);
					value.put("p2", p[1]);
					value.put("p3", p[2]);
					
					Constants.police[0]=p[0];
					Constants.police[1]=p[1];
					Constants.police[2]=p[2];
					
					if(first==0) {
						value.put("state", 1);
						Constants.police[3]=p[3];
	...
	public class MyOnItemSelectedListener implements OnItemSelectedListener {
	    ...
	    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
	    	...
	    	else if(parent.getId()==R.id.pmotion2) {
	    	...
	    	else if(parent.getId()==R.id.pmotion3){
