...
public class P_FriendActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.p_friend);

		tvmotion = new TextView[3];
		tvmotion[0] =(TextView)findViewById(R.id.ftvmotion1);
		tvmotion[1] =(TextView)findViewById(R.id.ftvmotion2);
		tvmotion[2] =(TextView)findViewById(R.id.ftvmotion3);
		
		ivmotion =(ImageView)findViewById(R.id.fivmotion);
		
		motion1 = (Spinner) findViewById(R.id.fmotion1);
		motion2 = (Spinner) findViewById(R.id.fmotion2);
		motion3 = (Spinner) findViewById(R.id.fmotion3);

		ok=(Button)findViewById(R.id.Fsave);
		no=(Button)findViewById(R.id.Fcan);
		
		sw=(Switch)findViewById(R.id.fswitch);
		...
		sw.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
				...
				if(isChecked) { //On
					...
					value.put("state", 1);
					Constants.people[3]="1";
					
					sqlDB.update("pt", value, "name='people'", null);
			...
			public void onClick(View v) {
				...
				while (cur.moveToNext()) {
					if(cur.getString(1).equals(p[0])&&cur.getString(2).equals(p[1])&&cur.getString(3).equals(p[2])) {
						if(cur.getString(0).equals("people")) 
							duplication = 2;
				...
				if(duplication==0) { //중복되지 않을 경우 DB에 저장
					...
					ContentValues value = new ContentValues();
					value.put("name", "people");
					value.put("p1", p[0]);
					value.put("p2", p[1]);
					value.put("p3", p[2]);
					
					Constants.people[0]=p[0];
					Constants.people[1]=p[1];
					Constants.people[2]=p[2];

					if(first==0) {
						value.put("state", 1);
						Constants.people[3]=p[3];
	...
	public class MyOnItemSelectedListener implements OnItemSelectedListener {
	    ...
	    public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
	    	...
	    	else if(parent.getId()==R.id.fmotion2){
	    	...
	    	else if(parent.getId()==R.id.fmotion3){
